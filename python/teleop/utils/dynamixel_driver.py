...
from typing import Protocol, Sequence, Dict, Optional, Sequence, Tuple
import os
import sys

# Add DynamixelSDK to path
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
PYTHON_DIR = os.path.dirname(os.path.dirname(CURRENT_DIR))  # Go up to python/
DYNAMIXEL_SDK_DIR = os.path.join(PYTHON_DIR, "third_party", "DynamixelSDK", "python", "src")
sys.path.insert(0, DYNAMIXEL_SDK_DIR)
